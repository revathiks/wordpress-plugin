            ...
            <div id="content"  class="col-7">  
                ...
                <div class="archivesS-category">		
                    <div class="archivesS colm-7">
                        <div class="label_style">News / Announcements </div> 
                        <div class="select_style">
                                <?php
                                if (empty($_POST['news_month']) && empty($_POST['news_year']) && empty($_GET['cpage'])) {
                                    unset($_SESSION["news_year"]);
                                    unset($_SESSION["news_month"]);
                                }
                                if (isset($_POST['news_month'])) {
                                    unset($_SESSION["news_month"]);
                                    $_SESSION["news_month"] = $_POST['news_month'];
                                }
                                if (isset($_POST['news_year'])) {
                                    $_SESSION["news_year"] = $_POST['news_year'];
                                }
                                $submittedYear = isset($_SESSION["news_year"]) ? $_SESSION["news_year"] : "";
                                $submittedMonth = isset($_SESSION["news_month"]) ? $_SESSION["news_month"] : "";
...
//                            $submittedMonth=$_SESSION["academic_month"];
                                 ...
                                 */
                                ?>
                                <select disabled id="news_YearId" class="select-year">
...
<form id="news_form" method="POST" action="<?php echo esc_url(the_permalink()); ?>">
                <input type="hidden" name="news_year" class="year"></input>
                <input type="hidden" name="news_month" class="month"></input>
            </form>
...
//                            var current_month = 3;
                    ...
                    select = document.getElementById('news_YearId');
